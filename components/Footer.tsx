            ...
            <div className="section-footer">
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
                        ...
                        <div className="section-footer-detail">
                            <div className="section-footer-text">
                                ...
                                <div className="flex items-center">
                                    <span>
                                        <svg fill="orange" width="25px" height="25px" viewBox="-7 -2 24 24" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span>
                                        <svg fill="orange" width="25px" height="25px" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span>
                                        <svg className='ms-2 icon' fill="orange" width="25px" height="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                            data-name="Layer 1">
                                            <path
                                    ...
                                    <span>
                                        <svg className="ms-2 icon" width="25px" height="25px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="white">
                        ...
                        <div className="footer-detail">
                            <h5 className="font-extrabold text-2xl mb-3">DO YOU HAVE A QUESTION?</h5>
                            <div className="flex items-center">
                                <p>
                                ...
                                <p className="ms-2 fw-bolder">Tel:+1-543-37-087</p>
                            </div>
                            <div className="flex items-center">
                                <p>
                                ...
                                <p className="ms-2">beautydiva@diva.com</p>
                            </div>
                            <div className="flex items-center">
                                <p>
                                ...
                                <p className="ms-2">894 Berverhills Street ,Carlifornia</p>
                            </div>
                        </div>
                    </div>
                    <p className="text-center text-yellow-500 mt-20 font-extrabold ">&copy;Copyright , 2024 DASCOM Ltd</p>
