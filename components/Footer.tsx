                        ...
                        <div className="section-footer-detail">
                            <div className="section-footer-text">
                                ...
                                <div className="flex items-center">
                                    <span>
                                        <svg fill="orange" width="20px" height="20px" viewBox="-7 -2 24 24" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span>
                                        <svg  fill="orange" width="20px" height="20px" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span>
                                        <svg className='ms-2 icon' fill="orange" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                            data-name="Layer 1">
                                            <path
