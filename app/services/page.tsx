          ...
          <div className="container mx-auto px-4">
            <div className="hero-text">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-6">
                <Link href="/login" className='px-12 py-3 rounded-full border-2 border-white transition duration-700 ease-in-out  bg-transparent hover:bg-white hover:text-black'>Get in touch</Link>
                <Link href="/about" className='px-12 py-3 rounded-full border-2 border-white transition duration-700 ease-in-out  bg-transparent hover:bg-white hover:text-black'>Know More</Link>
              </div>
            </div>
          </div>
        </div>
